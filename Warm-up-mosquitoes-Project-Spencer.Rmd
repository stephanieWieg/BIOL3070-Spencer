...
# BACKGROUND
Westnile virus is transmitted from birds to other species and humans by mosquitoes. In order to track the species that mosquitoes visit for their bloodmeals we can collect them and use PCR to extract tags that allow us to identify the animals. This will allow us to understadn which species are experiencing viremia and are living close to humans where they can recieve the virus from them. 
...
## Questions  
Which species are in most abundance of the mosquitoes for taking blood meals from in areas that are experiencing human WNV cases? 
...
## Prediction
House finche DNA will be found in higher concentration of the collected blood meals in areas where viremia is present. 

# METHODS

Mosquitoes were collected in areas near salt lake. Their bloodmeal DNA was extracted using PCR analysis of a gene found in the mitochondria. Results from this test were used to identify the organism using the BLASTn DNA database. Results were taken from the most closely related or highest percent match. 

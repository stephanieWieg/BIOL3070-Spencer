...
their bloodmeals we can collect them and use PCR to extract tags that
allow us to identify the animals. This will allow us to understadn which
species are experiencing viremia and are living close to humans where
they can recieve the virus from them.
...
Which species are in most abundance of the mosquitoes for taking
bloodmeals from in areas that are experiencing human WNV cases?

## Hypothesis

If house finches are a main host for viremia disease then we will see a
